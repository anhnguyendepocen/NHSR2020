...
_Copy relevant code from below to [R/02_hello_keras.R](R/02_hello_keras.R) and create a working model_
...
```{r conf_mat_vis, fig.align="center", fig.width=10, fig.height=3, echo=TRUE}
plot_dat %>%
...
### Conclusion
Here, we created a 3-class predictor with an accuracy of `r round(perf["accuracy"],3)*100`% on a left out data partition. I hope, this illustrates how relatively simple it is to get started with `Keras`.
